                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6">
                    <div>
                        <div className="flex items-center gap-3 mb-4">
                            ...
                            <Link
                                to="/shop"
                                className="flex lg:hidden items-center gap-2 px-4 py-2 bg-gold/10 text-gold border border-gold/20 rounded-xl text-[9px] font-black uppercase tracking-widest hover:bg-gold hover:text-white transition-all duration-500"
                            >
                                <ShoppingBag size={12} />
                                View Shop
                            </Link>
                        ...
                        <div className="flex flex-wrap items-center gap-4 mb-3">
                            ...
                            <Link
                                to="/shop"
                                className="hidden lg:flex items-center gap-2 px-6 py-2 bg-gold/10 text-gold border border-gold/20 rounded-2xl text-[10px] font-black uppercase tracking-widest hover:bg-gold hover:text-white transition-all duration-500 group shadow-lg shadow-gold/5"
                            >
