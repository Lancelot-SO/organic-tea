            ...
            {isCartOpen && (
                <div className="fixed inset-0 z-100 flex items-center justify-center p-4">
                    ...
                    <motion.div
                        ...
                        className="absolute inset-0 bg-primary-dark/40 backdrop-blur-xs"
                    />
                    ...
                    >
                        ...
                        {/* Cart Items List */}
                        <div className="grow overflow-y-auto px-8 py-2 space-y-3 custom-scrollbar">
                            {cartItems.length === 0 ? (
                                ...
                                cartItems.map((item, i) => (
                                    ...
                                    >
                                        <div className="w-16 h-16 bg-cream/30 rounded-xl flex items-center justify-center overflow-hidden shrink-0">
                                            <img src={item.image_url} alt={item.name} className="w-12 h-12 object-contain" crossOrigin="anonymous" />
                                        </div>
